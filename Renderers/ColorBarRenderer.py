...
class ColorBarRenderer(Renderer):
	def __init__(self):
		...
		self.coloroptions={"TextColor":[0,0,0],"BackgroundColor":[0,152,140],"ValueColor":[0,0,0]}
	...
	def draw(self,keyValuePair):
		...
		self.drawer.drawCenteredValue(str(value)[:2],50,self.coloroptions["ValueColor"],"8x13")
